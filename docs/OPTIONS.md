...
| `theme` | string | `"hud-clean"` | Base color palette. One of `hud-clean`, `tokyo-night`, `gruvbox`, `nord`, `mono`. |
...
| `context` | 7 | `context.bar`, `context-percentage`, `context-percentage-usable`, `context-length`, `context-window`, `context-1m`, `compaction-counter` |
