...
- Layout: **panel/framed style done**; remaining = full CSS-grid multi-column layout + flexMode auto-align engine (flex separators for right-align/spread are **done**), per-segment icon toggles.
