...
Early scaffold (v0.1.0). The render pipeline, widget registry, themes, config loading, and several widgets work today. The Ink TUI, full git/usage widget set, and SQLite stats are on the roadmap (see `docs/ANALYSIS.md`).
